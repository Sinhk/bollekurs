...
namespace Bollekurs.Pages.Mat
{
    public class IndexModel : PageModel
    {
        ...
        private static readonly Case[] Mat =
        {
            new Case("Ferdigmat", "Du skal argumentere for at det bare skal være ferdigmat.", new[] {"ferdigmat.png"}),
            new Case("REAL Turmat", "Du skal argumentere for at det bare skal være REAL Turmat.",
                new[] {"realturmat.png"}),
            new Case("Økologisk mat", "Du skal argumentere for at all maten skal være økologisk.",
                new[] {"okologisk.png"}),
            new Case("Vegetarmat", "Du skal argumentere for at all maten skal være vegetarisk.", new[] {"vegetar.png"}),
            new Case("Kortreis mat", "Du skal argumentere for at maten skal være mest mulig kortreist.",
                new[] {"kortreist.png"}),
            new Case("Hjemmelaget", "Du skal argumentere for at all maten skal lages fra bunnen av.",
                new[] {"hjemmelaget.png"}),
            new Case("Billig mat", "Du skal argumentere for at all maten skal være billigst mulig",
                new[] {"billig.png"}),
            new Case("Bare brød", "NEI, NEI, NEI, gi meg brød med smør på! Og ikke noe mer!", new[] {"brod.png"}),
            new Case("Restaurant", "Du skal argumentere for at vi skal spise på restaurant hver dag",
                new[] {"restaurant.png"}),
        };
        ...
        private int RandomCase()
        {
            ...
            var minIndexes = Matcounter.Select((count, index) => (count, index)).Where(i => i.count == min)
